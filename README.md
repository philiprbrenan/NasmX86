...
This [module](https://en.wikipedia.org/wiki/Modular_programming) provides dynamic [strings](https://en.wikipedia.org/wiki/String_(computer_science)), [arrays](https://en.wikipedia.org/wiki/Dynamic_array), [trees](https://en.wikipedia.org/wiki/Tree_(data_structure)) and quarks in [arenas](https://en.wikipedia.org/wiki/Region-based_memory_management): every
such [data structure](https://en.wikipedia.org/wiki/Data_structure) is [process](https://en.wikipedia.org/wiki/Process_management_(computing)) friendly because [arenas](https://en.wikipedia.org/wiki/Region-based_memory_management) are completely [relocatable](https://en.wikipedia.org/wiki/Relocation_%28computing%29) and so can be easily moved between different [processes](https://en.wikipedia.org/wiki/Process_management_(computing)) via a [file](https://en.wikipedia.org/wiki/Computer_file) or
a [socket](https://en.wikipedia.org/wiki/Network_socket) or reused via shared [memory](https://en.wikipedia.org/wiki/Computer_memory). 
